...
const mysUrl = "https://api-static.mihoyo.com/common/blackboard/ys_obc/v1/home/content/list?app_sn=ys_obc&channel_id=189";
...
if (!fileExist(amberSavePath)) {
	...
	consoleLogger.mark("[武器][下载] amber.json 已存在，跳过下载");
}
...
defaultLogger.info(`[武器][下载] 图片下载完成，共 ${count.total} 张，成功 ${count.success} 张，失败 ${count.fail} 张，跳过 ${count.skip} 张`);
