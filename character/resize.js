...
// paths
const ambrJson = JSON.parse(fs.readFileSync(path.join(ORI_DATA_PATH, "/character/ambr.json")));
const oriPath = path.join(ORI_SRC_PATH, "/character");
const savePath = path.join(SRC_PATH, "/character");
